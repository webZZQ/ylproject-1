/*
 ...
 Source Schema         : ylproject

 Target Server Type    : MySQL
 Target Server Version : 80015
 File Encoding         : 65001

 Date: 27/10/2019 22:16:56
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_action_log` VALUES (1, '角色状态', 1, '127.0.0.1', 'com.linln.admin.system.controller.RoleController', 'status', NULL, NULL, '删除ID：[15]', '2019-04-28 00:08:45', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (2, '日志管理', 1, '127.0.0.1', 'com.linln.admin.system.controller.RoleController', 'save', 'sys_role', 2, '更新日志成功：用户组1', '2019-04-28 00:09:06', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (3, '日志管理', 1, '127.0.0.1', 'com.linln.admin.system.controller.RoleController', 'save', 'sys_role', 3, '更新日志成功：用户组2', '2019-04-28 00:09:17', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (4, '日志管理', 1, '127.0.0.1', 'com.linln.admin.system.controller.RoleController', 'save', 'sys_role', 2, '更新日志成功：用户组1', '2019-04-28 00:09:28', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (5, '日志管理', 1, '127.0.0.1', 'com.linln.admin.system.controller.RoleController', 'save', 'sys_role', 2, '更新日志成功：用户组', '2019-04-28 00:09:32', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (6, '日志管理', 1, '127.0.0.1', 'com.linln.admin.system.controller.RoleController', 'save', 'sys_role', 2, '更新日志成功：开发组', '2019-04-28 00:10:00', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (7, '日志管理', 1, '127.0.0.1', 'com.linln.admin.system.controller.RoleController', 'save', 'sys_role', 3, '更新日志成功：用户组', '2019-04-28 00:11:09', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (8, '菜单状态', 1, '127.0.0.1', 'com.linln.admin.system.controller.MenuController', 'status', NULL, NULL, '删除ID：[6, 2, 7, 16, 15, 17, 18, 19, 20, 4, 5, 11, 12, 13, 14, 1, 3, 8, 9, 10, 136, 137, 138, 139, 140, 21, 22, 23, 24, 25, 26, 27, 28, 30, 31, 125, 146]', '2019-04-28 00:12:55', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (9, '菜单管理', 1, '127.0.0.1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 157, '添加菜单：主页', '2019-04-28 00:13:59', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (10, '菜单管理', 1, '127.0.0.1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 158, '添加菜单：系统管理', '2019-04-28 00:14:39', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1051, '用户登录', 2, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.LoginController', 'login', NULL, NULL, '后台登录成功', '2019-10-26 17:47:49', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1052, '用户登录', 2, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.LoginController', 'login', NULL, NULL, '后台登录成功', '2019-10-26 17:51:27', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1053, '部门管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.DeptController', 'save', 'sys_dept', 6, '添加部门：销售部门', '2019-10-26 18:05:26', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1054, '用户登录', 2, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.LoginController', 'login', NULL, NULL, '后台登录成功', '2019-10-27 14:26:49', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1055, '用户登录', 2, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.LoginController', 'login', NULL, NULL, '后台登录失败：[admin]用户名或密码错误', '2019-10-27 14:45:08', 'admin', NULL);
INSERT INTO `sys_action_log` VALUES (1056, '用户登录', 2, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.LoginController', 'login', NULL, NULL, '后台登录成功', '2019-10-27 14:45:12', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1057, '用户登录', 2, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.LoginController', 'login', NULL, NULL, '后台登录成功', '2019-10-27 15:17:54', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1058, '用户登录', 2, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.LoginController', 'login', NULL, NULL, '后台登录成功', '2019-10-27 15:29:52', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1059, '用户登录', 2, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.LoginController', 'login', NULL, NULL, '后台登录成功', '2019-10-27 15:40:32', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1060, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 30, '更新菜单：入院管理', '2019-10-27 16:03:12', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1061, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 159, '添加菜单：老人开卡', '2019-10-27 16:07:28', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1062, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 160, '添加菜单：老人基本信息', '2019-10-27 16:10:20', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1063, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 161, '添加菜单：财务核算', '2019-10-27 16:12:24', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1064, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 161, '更新菜单：财务核算', '2019-10-27 16:16:14', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1065, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 162, '添加菜单：室内活动', '2019-10-27 16:17:12', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1066, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 2, '更新菜单：系统管理', '2019-10-27 17:07:36', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1067, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 2, '更新菜单：系统管理', '2019-10-27 17:08:05', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1068, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 163, '添加菜单：咨询预约', '2019-10-27 17:12:33', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1069, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 30, '更新菜单：菜单管理', '2019-10-27 17:13:29', '超级管理员', 1);
INSERT INTO `sys_action_log` VALUES (1070, '菜单管理', 1, '0:0:0:0:0:0:0:1', 'com.linln.admin.system.controller.MenuController', 'save', 'sys_menu', 164, '添加菜单：入院管理', '2019-10-27 17:14:28', '超级管理员', 1);
COMMIT;
...
INSERT INTO `sys_dept` VALUES (6, '销售部门', 1, '[0],[1]', 5, '', '2019-10-26 18:05:26', '2019-10-26 18:05:26', 1, 1, 1);
COMMIT;
...
INSERT INTO `sys_menu` VALUES (2, '系统管理', 0, '[0]', '#', '#', 'layui-icon layui-icon-cellphone', 1, 8, '', '2018-09-29 00:05:50', '2019-10-27 17:14:28', 1, 1, 1);
...
INSERT INTO `sys_menu` VALUES (6, '安全服务', 0, '[0]', '/index', 'index', 'layui-icon layui-icon-notice', 1, 1, '', '2018-09-29 00:09:56', '2019-02-27 21:34:56', 1, 1, 1);
...
INSERT INTO `sys_menu` VALUES (30, '菜单管理', 0, '[0]', '#', '#', 'layui-icon layui-icon-log', 1, 9, '', '2018-10-19 16:38:23', '2019-10-27 17:14:28', 1, 1, 1);
...
INSERT INTO `sys_menu` VALUES (159, '老人开卡', 0, '[0]', '#', '#', 'layui-icon layui-icon-layouts', 1, 4, '', '2019-10-27 16:07:28', '2019-10-27 17:14:28', 1, 1, 1);
INSERT INTO `sys_menu` VALUES (160, '老人基本信息', 0, '[0]', '#', '#', 'fa fa-blind', 1, 5, '', '2019-10-27 16:10:20', '2019-10-27 17:14:28', 1, 1, 1);
INSERT INTO `sys_menu` VALUES (161, '财务核算', 0, '[0]', '#', '#', 'fa fa-bank', 1, 6, '', '2019-10-27 16:12:24', '2019-10-27 17:14:28', 1, 1, 1);
INSERT INTO `sys_menu` VALUES (162, '室内活动', 0, '[0]', '#', '#', 'fa fa-user-circle-o', 1, 7, '', '2019-10-27 16:17:12', '2019-10-27 17:14:28', 1, 1, 1);
INSERT INTO `sys_menu` VALUES (163, '咨询预约', 0, '[0]', '#', '#', 'fa fa-glass', 1, 2, '', '2019-10-27 17:12:33', '2019-10-27 17:12:33', 1, 1, 1);
INSERT INTO `sys_menu` VALUES (164, '入院管理', 0, '[0]', '#', '#', 'layui-icon layui-icon-log', 1, 3, '', '2019-10-27 17:14:28', '2019-10-27 17:14:28', 1, 1, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 'admin', '超级管理员', '3dd0affe1e514fa059d00bf63134fe48d45acd3f350aaed83b0b54ef05579092', '3ABR79', 2, NULL, '1', '10086@163.com', '10086', '', '2019-08-09 23:00:03', '2020-04-28 00:07:21', 1);
INSERT INTO `sys_user` VALUES (2, 'test', '测试', 'f061ad891b99463f49e79b80fda22a2c2d320a248d485c6d8f188fb79be72a9b', '5f444i', 2, NULL, '2', '1008612@qq.com', '1008612', '', '2019-09-30 16:25:22', '2020-04-28 00:07:47', 1);
COMMIT;
